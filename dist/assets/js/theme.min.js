...
var demoMode = (function () {
	...
	return (
		...
		"base" == (a = S.sidebarSize) ? A(h) : "small" == a && A(f),
		(o = c),
		(l = S.colorScheme),
		(n = S.navPosition),
		(r = S.navColor),
		...
		c &&
			(c.addEventListener("submit", function (e) {
				...
				e.preventDefault(),
					...
					(n = t.querySelector('[name="sidebarSize"]:checked').value),
...
!(function () {
	...
	"undefined" != typeof Chart &&
		...
		(Chart.defaults.global.tooltips.custom = function (n) {
			...
			if (
				(e ||
					((e = document.createElement("div")).setAttribute("id", "chart-tooltip"),
						...
						a.forEach(function (e, t) {
							var a = n.labelColors[t],
								o =
									...
									("line" === r && "rgba(0,0,0,0.1)" !== a.borderColor
										? a.borderColor
										: a.backgroundColor) +
									'"></span>',
								l =
		...
		(Chart.defaults.global.tooltips.callbacks.label = function (e, t) {
			...
			return (
				1 <
					...
					(a = '<span class="popover-body-label mr-auto">' + n + "</span>"),
		...
		t &&
			[].forEach.call(t, function (l) {
				l.addEventListener("click", function (e) {
					var t, a, o;
					e.preventDefault(),
						(a = (t = l).parentElement.querySelector(".dropdown-menu")),
						(o = t.closest(".dropdown-menu").querySelectorAll(".dropdown-menu")),
			...
			$(e).on("hide.bs.dropdown", function () {
				var e;
				(e = this.querySelectorAll(".dropdown-menu")) &&
					[].forEach.call(e, function (e) {
			...
			[].forEach.call(e, function (e) {
				...
				(a = (t = e).dataset.options ? JSON.parse(t.dataset.options) : {}),
					(o = {
						...
						dropdownParent: t.closest(".modal")
							? t.closest(".modal")
							: document.body,
						templateResult: n,
					}),
